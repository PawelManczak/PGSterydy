...
PRESTASHOP_URL = "https://localhost:18875/"
SEARCH_PRODUCT = "5 tab"
...
class PrestaShopTests(unittest.TestCase):
    ...
    def add_ten_elements_to_cart(self):
        ...
        print("items in basket:  " + str(len(self.driver.find_elements(By.CLASS_NAME, "cart-item"))))
    ...
    def vat_invoice(self):
        ...
        self.driver.find_element(By.CLASS_NAME, "order-actions").find_elements(By.TAG_NAME, "a")[0].click()
        time.sleep(2)
        self.driver.find_element(By.ID, "order-infos").find_elements(By.TAG_NAME, "a")[0].click()
